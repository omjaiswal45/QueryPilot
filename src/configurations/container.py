...
TODO:
- get_app_db_session() -> yields a SQLAlchemy session (infrastructures/db/app_db_client.py)
- get_llm_client() -> returns the shared LLM client (infrastructures/llm/llm_client.py)
- get_business_db_connector() -> returns infrastructures/db/business_db_client.py
